...
<body>
    ...
    <div class="success-container">
        ...
        <p class="success-subtitle">Tu contraseña ha sido restablecida exitosamente</p>

        <!-- Mensaje de confirmación -->
        <div class="success-message">
            <i class="fas fa-shield-alt" style="color: #28a745; margin-right: 8px;"></i>
            Tu cuenta ahora está protegida con tu nueva contraseña. Ya puedes iniciar sesión con tu nueva credencial.
        </div>
